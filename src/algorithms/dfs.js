export function dfs(grid, startNode, endNode) {
    ...
    dfsRecursive(grid, startNode, endNode, visitedNodesInOrder);
    return visitedNodesInOrder;
}

function dfsRecursive(grid, node, endNode, visitedNodesInOrder) {
    node.isVisited = true;
    ...
    for (let i = 0; i < 4; ++i) {
        ...
        if (dfsRecursive(grid, neighbor, endNode, visitedNodesInOrder)) return true;
    }
    return false;
